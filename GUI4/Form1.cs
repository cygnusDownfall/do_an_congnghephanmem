...
namespace GUI4
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            try { SqlCommand cmd = DataBase.Cmd("update dangnhap set taikhoan = '" + tTenNd.Text + "' ,matkhau ='" + tMk.Text + "',TenND = '" + tTenNd.Text + "',SĐT = '" + tSĐTNd.Text + "',CMND = '" + tCMNDNd.Text + "',Chucvu = " + cbCvu.Text + " where SĐT = '" + tSĐTNd.Text + "'");
                cmd.ExecuteNonQuery();
                loadNd(); }
            catch (Exception ex) { MessageBox.Show(ex.Message, "lỗi", MessageBoxButtons.OK); }
        ...
        {
            try { SqlCommand cmd = DataBase.Store("XoaNd");
        ...
        {
            try { SqlCommand cmd = DataBase.Cmd("insert into PHIEUDATPHONG(maphieudatphong,makhachhang,maphong,ngaythue,ngaytra,songayo,datcoc) values ('" + txtMaPhieu.Text + "','" + txtMaKH.Text + "','" + txtMaPhong.Text + "','" + dateĐP.Value + "',dateadd(day," + nmNgayO.Value + ",'" + dateĐP.Value + "')," + nmNgayO.Value.ToString() + "," + cbDatcoc.Text.ToString() + ")");
                cmd.ExecuteNonQuery();
                loadFPhong(); }
            catch (Exception ex) { MessageBox.Show(ex.Message, "lỗi", MessageBoxButtons.OK); }
        ...
        {
            try { SqlCommand cmd = DataBase.Cmd("delete from DICHVU where maphieudatphong = '" + dgvDichvu.CurrentRow.Cells[0].Value.ToString() + "'");
                cmd.ExecuteNonQuery();
                loadDV(); }
            catch (Exception ex) { MessageBox.Show(ex.Message, "lỗi", MessageBoxButtons.OK); }
